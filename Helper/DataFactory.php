...
class DataFactory
{
     ...
     */
    protected $helperMap = [
        self::AREA_FRONTEND => 'PayU\Gateway\Helper\Data',
        self::AREA_BACKEND => 'PayU\Gateway\Helper\Backend\Data'
    ];
     ...
     *
     * @param string $area
     * @return \PayU\Gateway\Helper\Backend\Data|\PayU\Gateway\Helper\Data
