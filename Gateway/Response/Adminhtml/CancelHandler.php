...
class CancelHandler implements HandlerInterface
{
    ...
    public function handle(array $handlingSubject, array $response): void
    {
        ...
        $message = 'Payment transaction amount of %1 was canceled by Merchant.<br/>' . 'PayU reference "%2"<br/>';
        ...
        if ($incrementId) {
            ...
            if (!$payment || $payment->getMethod() != $orderPayment->getMethod()) {
                throw new LocalizedException(
                    __("This didn't work out because we can't find the payment method.")
                );
            }
